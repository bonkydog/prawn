    ...
    class Cell
      ...
      class Image < Cell
        ...
        def initialize(pdf, point, options={})
          ...
          @image_options[:image_info] = pdf.image file.path, options.merge(:no_display => true) # store image information
        ...
        def draw_content
          ...
          @pdf.image file.path, :at => [0, @pdf.cursor], :height => content_height + FPTolerance
